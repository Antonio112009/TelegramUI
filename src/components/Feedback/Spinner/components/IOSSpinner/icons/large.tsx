...
export const IconLarge = ({ children, ...restProps }: Icon) => (
  ...
  >
    <g transform="matrix(1,0,0,1,0,0)">
      <g id="l151:1947" opacity="1" style={{ mixBlendMode: 'normal' }}>
        <g>
          <defs>
            <clipPath
          ...
          <g clipPath="url(#l151:1947_clipPath)">
            <g transform="matrix(-0.7071067811865475,-0.7071067811865476,0.7071067811865476,-0.7071067811865475,9.2715,37.5564)">
              <g
                id="l151:1985"
                opacity="0.837"
            ...
            <g transform="matrix(0.7071067811865476,-0.7071067811865475,0.7071067811865475,0.7071067811865476,24.8291,27.6569)">
              <g
                id="l151:1982"
                opacity="0.153"
                style={{ mixBlendMode: 'normal' }}
            ...
            <g transform="matrix(-0.7071067811865475,-0.7071067811865476,0.7071067811865476,-0.7071067811865475,27.6592,19.1716)">
              <g
                id="l151:1986"
                opacity="0.01"
                style={{ mixBlendMode: 'normal' }}
            ...
            <g transform="matrix(1,0,0,1,20,2)">
              <g id="l151:1979" opacity="0" style={{ mixBlendMode: 'normal' }}>
                <g>
                  <g>
                    <path
            ...
            <g transform="matrix(0.7071067811865476,-0.7071067811865475,0.7071067811865475,0.7071067811865476,6.4473,9.2721)">
              <g id="l151:1981" opacity="0" style={{ mixBlendMode: 'normal' }}>
                <g>
                  <g>
                    <path
            ...
            <g transform="matrix(6.123233995736766e-17,-1,1,6.123233995736766e-17,2,24)">
              <g id="l151:1983" opacity="1" style={{ mixBlendMode: 'normal' }}>
                <g>
                  <g>
                    <path
