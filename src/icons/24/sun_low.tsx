...
export const Icon24SunLow = ({ ...restProps }: Icon) => (
  <svg
    width="24"
    height="24"
    fill="none"
  ...
  >
    ...
    <path
      d="M13 20.5c0 .5523-.4477 1-1 1s-1-.4477-1-1 .4477-1 1-1 1 .4477 1 1Z"
      fill="currentColor"
    />
    <circle cx="5.5" cy="18.5" r="1" fill="currentColor" />
    <path
      d="M13 3.5c0 .55228-.4477 1-1 1s-1-.44772-1-1 .4477-1 1-1 1 .44772 1 1Z"
      fill="currentColor"
    />
  </svg>
);
